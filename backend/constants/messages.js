const MESSAGES = {
  ...
  DOCUMENT: {
    ...
    REQUIRED: "Upload both Resume and Job Description before starting chat",
  },
  ...
  SERVER: {
    ...
    CHAT_START_ERROR: "Server error while starting chat",
    CHAT_SEND_ERROR: "Server error while sending message",
  },
  //AI messages
  AI: {
    NO_KEY: "GEMINI_API_KEY not found in environment variables",
    INVALID_FORMAT:"Invalid AI response format.",
  },

  //chat messages
  CHAT: {
    DOCS_REQUIRED:
      "Upload both Resume and Job Description before starting chat",
    MISSING_FIELDS: "chatId and message required",
